...
export default memo(function HwAppFooter() {
        return (
            <AppFooterWrapper className='no-select'>
                <div className="wrap-v2 content">
                    <FooterLeft className="left">
                        ...
                        <div className="info">
                            ...
                            <a href="https://www.beian.miit.gov.cn/publish/query/indexFirst.action" rel="noopener noreferrer"
                               target="_blank">
                                工业和信息化部备案管理系统网站
                            </a>
                        </div>
